...
func TestParseAiTraceUpdate(t *testing.T) {
	roundTrip(t, `{"type":"ai.trace.update","deviceId":"11111111-1111-1111-1111-111111111111","aiSessionId":"22222222-2222-2222-2222-222222222222","trace":{"aiSessionId":"22222222-2222-2222-2222-222222222222","providerId":"codex","traceKind":"codex","status":"running","snapshot":{"provider":"codex","status":"running","items":[],"approvals":[],"errors":[],"finalText":"","updatedAt":"2024-01-02T03:04:05Z"},"segments":[{"type":"status","stepId":"runtime-status","label":"Codex 正在执行","icon":"think"}]}}`, "ai.trace.update")
}
...
func TestParseAiHistoryResponseWithTrace(t *testing.T) {
	roundTrip(t, `{"type":"ai.history.response","deviceId":"11111111-1111-1111-1111-111111111111","aiSessionId":"22222222-2222-2222-2222-222222222222","requestId":"33333333-3333-4333-8333-333333333333","messages":[],"trace":{"aiSessionId":"22222222-2222-2222-2222-222222222222","providerId":"codex","traceKind":"codex","status":"completed","snapshot":{"provider":"codex","status":"completed","items":[],"approvals":[],"errors":[],"finalText":"完成","updatedAt":"2024-01-02T03:04:05Z"},"segments":[{"type":"status","stepId":"final-summary","label":"已处理"}]}}`, "ai.history.response")
}
